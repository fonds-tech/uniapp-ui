...
const componentCategories = [
  ...
  },
  {
    ...
    components: [
      ...
      { name: "CalendarPanel", path: "calendar-panel", icon: "i-lucide-calendar-days", desc: "日历面板" },
      { name: "Cascader", path: "cascader", icon: "i-lucide-git-merge", desc: "级联" },
      { name: "CascaderPanel", path: "cascader-panel", icon: "i-lucide-git-merge", desc: "级联面板" },
      ...
      { name: "KeyboardPanel", path: "keyboard-panel", icon: "i-lucide-keyboard", desc: "键盘面板" },
      { name: "CodeInput", path: "code-input", icon: "i-lucide-password", desc: "验证码输入" },
      { name: "PickerPanel", path: "picker-panel", icon: "i-lucide-list", desc: "选择器面板" },
