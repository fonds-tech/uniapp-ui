...
const componentCategories = [
  ...
  },
  {
    ...
    components: [
      ...
      { name: "CountDown", path: "count-down", icon: "⏰", desc: "倒计时组件" },
      { name: "NumberRoll", path: "number-roll", icon: "🔢", desc: "数字滚动组件" },
      { name: "NoticeBar", path: "notice-bar", icon: "📢", desc: "通知栏组件" },
  ...
  },
  {
    ...
    key: "layout",
    components: [
      { name: "Row", path: "row", icon: "➡️", desc: "行组件" },
      { name: "Col", path: "col", icon: "⬇️", desc: "列组件" },
      { name: "Header", path: "header", icon: "🔝", desc: "页头组件" },
      { name: "Footer", path: "footer", icon: "🔚", desc: "页脚组件" },
      { name: "Sticky", path: "sticky", icon: "📌", desc: "粘性布局组件" },
      { name: "SafeAreaTop", path: "safe-area-top", icon: "📱", desc: "顶部安全区" },
      { name: "SafeAreaBottom", path: "safe-area-bottom", icon: "📱", desc: "底部安全区" },
    ],
  },
]
