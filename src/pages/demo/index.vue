...
const componentCategories = [
  ...
  },
  {
    ...
    components: [
      ...
      { name: "DateRangePicker", path: "date-range-picker", icon: "📅", desc: "日期范围选择器" },
      ...
      { name: "ColorPanel", path: "color-panel", icon: "🎨", desc: "颜色面板" },
      { name: "ColorPicker", path: "color-picker", icon: "🖌️", desc: "颜色选择器" },
    ],
  },
  {
    name: "反馈组件",
