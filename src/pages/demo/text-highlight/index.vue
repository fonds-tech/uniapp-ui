<template>
  <view class="demo-page">
    ...
    <!-- 多个匹配 -->
    <view class="demo-section">
      <text class="section-title">多个匹配</text>
      <view class="demo-block">
    ...
    <view class="demo-section">
      ...
      <view class="demo-block">
        <ui-text-highlight text="TypeScript 是 JavaScript 的超集，提供了类型系统" match="TypeScript" highlight-color="#2ed573" />
      </view>
      <view class="demo-block">
        <ui-text-highlight text="React 和 Vue 都是流行的前端框架" match="React" highlight-color="#1e90ff" />
      </view>
    </view>

    <!-- 自定义文本样式 -->
    <view class="demo-section">
      <text class="section-title">自定义文本样式</text>
      <view class="demo-block">
    ...
    <!-- 多行文本 -->
    <view class="demo-section">
      <text class="section-title">多行文本</text>
      <view class="demo-block">
        <ui-text-highlight
          :text="longText"
          match="组件"
    ...
    <!-- 搜索场景 -->
    <view class="demo-section">
      <text class="section-title">搜索场景</text>
      <view class="demo-block">
