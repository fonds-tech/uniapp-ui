...
| labelGap        | 描述信息顶部间隔     | numericProp                                           | -      | -      |
| labelSize       | 描述信息大小         | numericProp                                           | -      | -      |
| labelColor      | 描述信息颜色         | string                                                | -      | -      |
| labelWeight     | 描述信息粗细         | numericProp                                           | -      | -      |
| valueSize       | 内容大小             | numericProp                                           | -      | -      |
| valueColor      | 内容颜色             | string                                                | -      | -      |
| valueWeight     | 内容粗细             | numericProp                                           | -      | -      |
| rightIcon       | 右侧图标             | makeStringProp("arrow")                               | -      | -      |
| rightIconGap    | 右侧图标距离左边间隔 | string                                                | -      | -      |
| rightIconSize   | 右侧图标大小         | numericProp                                           | -      | -      |
| rightIconColor  | 右侧图标颜色         | string                                                | -      | -      |
| rightIconWeight | 右侧图标粗细         | numericProp                                           | -      | -      |
| url             | 跳转链接             | string                                                | -      | -      |
| linkType        | 跳转类型             | string                                                | -      | -      |
| border          | 是否显示边框         | truthProp                                             | -      | -      |
| borderColor     | 边框颜色             | string                                                | -      | -      |
| borderLeft      | 边框左侧位置         | numericProp                                           | -      | -      |
| borderRight     | 边框右侧位置         | numericProp                                           | -      | -      |
| borderWidth     | 边框宽度             | numericProp                                           | -      | -      |
