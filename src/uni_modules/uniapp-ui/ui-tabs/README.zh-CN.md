...
| activeSize     | 激活文字大小                 | numericProp                                           | -      | -      |
| activeColor    | 激活文字颜色                 | string                                                | -      | -      |
| activeWeight   | 激活文字粗细                 | numericProp                                           | -      | -      |
| inactiveSize   | 未激活文字大小               | numericProp                                           | -      | -      |
| inactiveColor  | 未激活文字颜色               | string                                                | -      | -      |
| inactiveWeight | 未激活文字粗细               | numericProp                                           | -      | -      |
| lineColor      | 激活线条颜色                 | string                                                | -      | -      |
| lineWidth      | 激活线条宽度                 | makeNumericProp("40rpx")                              | -      | -      |
| lineHeight     | 激活线条高度                 | numericProp                                           | -      | -      |
| lineRadius     | 激活线条圆角                 | numericProp                                           | -      | -      |
| showLine       | 是否显示线条                 | truthProp                                             | -      | -      |
| tabWidth       | 宽度                         | numericProp                                           | -      | -      |
| tabMaxWidth    | 最大宽度                     | numericProp                                           | -      | -      |
