...
import type {
  CalendarPanelDay,
  CalendarPanelType,
  CalendarPanelDayType,
  CalendarPanelFormatter,
  CalendarPanelSelectData,
  CalendarPanelConfirmData,
  CalendarPanelMonthChangeData,
} from "../ui-calendar-panel"
import { buildDefaultProps } from "../utils/props"

/** 日历选择模式 */
export type CalendarType = CalendarPanelType

/** 日历日期项类型 */
export type CalendarDayType = CalendarPanelDayType

/** 日历日期项 */
export type CalendarDay = CalendarPanelDay

/** 日期格式化函数 */
export type CalendarFormatter = CalendarPanelFormatter

/** 月份变化数据 */
export type CalendarMonthChangeData = CalendarPanelMonthChangeData

/** 选择事件数据 */
export type CalendarSelectData = CalendarPanelSelectData

/** 确认事件数据 */
export type CalendarConfirmData = CalendarPanelConfirmData
