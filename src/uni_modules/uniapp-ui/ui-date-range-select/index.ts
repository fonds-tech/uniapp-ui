...
const defaultProps = buildDefaultProps("date-range-select", {
  modelValue: () => [],
...
export const dateRangeSelectProps = {
  /** 绑定日期区间值 [开始日期, 结束日期] */
  modelValue: defaultProps("modelValue", { type: Array as unknown as PropType<DateRangeSelectValue> }),
  /** 开始日期占位文案 */
  startPlaceholder: defaultProps("startPlaceholder", { type: String }),
  /** 结束日期占位文案 */
  endPlaceholder: defaultProps("endPlaceholder", { type: String }),
  /** 分隔符 */
  separator: defaultProps("separator", { type: String }),
  /** 是否禁用 */
  ...
  /** 展示文案格式化 */
  displayFormatter: defaultProps("displayFormatter", { type: Function as PropType<DateRangeSelectDisplayFormatter> }),
  /** 右侧图标 */
  ...
  /** 分隔符颜色 */
  separatorColor: defaultProps("separatorColor", { type: String }),
  /** 自定义类名 */
