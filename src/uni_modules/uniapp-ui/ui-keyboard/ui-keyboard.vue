<template>
  ...
  >
    <ui-keyboard-panel
      ...
      :cancel-text-size="props.cancelTextSize"
      :cancel-text-color="props.cancelTextColor"
      :cancel-text-weight="props.cancelTextWeight"
      :show-confirm="props.showConfirm"
      :confirm-text="props.confirmText"
      :confirm-text-size="props.confirmTextSize"
      :confirm-text-color="props.confirmTextColor"
      :confirm-text-weight="props.confirmTextWeight"
      :background="props.background"
